...
?>			
				<div class="col-md-3 feature-grid">
                    ...
                    <a href="edit.php?id=<?php echo $row['tshirt_id'] ?>" style="margin-top:5px;" class="btn btn-danger" />Edit Product</a> 
                   	...
                   	<a href="ad-product.php?aid=<?php echo $row['tshirt_id'] ?>" style="margin-top:5px;" class="btn btn-danger" onclick="return confirm('Delete product from database?')">Delete Product</a>
                          </div>  
                     </form>  
                </div>  
            </div>
   ...
   if(isset($_GET['aid'])){
   	$id =  $_GET['aid'];
   	$sql = ("DELETE FROM tshirt WHERE tshirt_id = $id");
