<?php
	...
	$mail -> addAddress($email); //received person
	
	//email Subject
	$mail -> Subject = 'Thank You!';
	
	//email body
	$mail -> msgHTML("<h1>Reset Password, http://localhost:8081/shin_clothes/repassword.html?token=$str&email=$email, the code number is $str .</h1>");
