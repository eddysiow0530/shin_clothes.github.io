...
?>			
				<div class="col-md-3 feature-grid">
					...
					<center>	
					 <input type="text" name="quantity" class="form-control" value="1" />  
					  <div class="viw">
						<a href="ad-gtproduct.php"><span class="glyphicon glyphicon-eye-open" aria-hidden="true"></span>View</a>
					</div>
                    ...
                    <a href="edit.php?id=<?php echo $row['tshirt_id'] ?>" style="margin-top:5px;" class="btn btn-danger" />Edit Product</a> 
                   	...
                   	<a href="ad-gtproduct.php?aid=<?php echo $row['tshirt_id'] ?>" style="margin-top:5px;" class="btn btn-danger" onclick="return confirm('Delete product from database?')">Delete Product</a>
                          </div>  
                     </form>  
                </div>  
            </div>
   ...
   if(isset($_GET['aid'])){
   	$id =  $_GET['aid'];
   	$sql = ("DELETE FROM ftshirt WHERE tshirt_id = $id");
	...
	//g.end transfer back to view.php (previous page)
		...
		echo "<script>window.location.href = 'ad-gtproduct.php'</script>";
		}
