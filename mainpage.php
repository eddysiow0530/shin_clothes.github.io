...
<script src="js/bootstrap.js"> </script>
			...
			<div class="col-md-3 feature-grid">
				 <a href="product.php"><img src="images/img1.jpg" alt="kid image" width="400" height="350"/>
			 ...
			 <div class="col-md-3 feature-grid">
				 <a href="product.php"><img src="images/img2.jpg" alt="kid image" width="400" height="350"/>
					 <div class="arrival-info">
					 	<center>
						 <h4>Man Jeans</h4>
						 <p>Male Long-pants</p>
			 ...
			 <div class="col-md-3 feature-grid">
				 <a href="gt-product.php"><img src="images/img3.jpg" alt="Female image" width="400" height="350"/>
					 <div class="arrival-info">
					 	<center>
						 <h4>Girl Shirt</h4>
						 <p>Female T-shirt</p>
					 ...
					 <div class="viw">
						<a href="gt-product.php"><span class="glyphicon glyphicon-eye-open" aria-hidden="true"></span>View</a>
					 </div>
				  </a>
			 </div>
			 <div class="col-md-3 feature-grid">
				 <a href="gt-product.php"><img src="images/img4.jpg" alt="kid image" width="400" height="350"/>
					 <div class="arrival-info">
					 	<center>
						 <h4>Girl Dress</h4>
						 <p>Long Dress</p>
		 ...
		 <div class="items-sec btm-sec">
			 <div class="col-md-3 feature-grid">
				 <a href="kd-product.php"><img src="images/img5.jpg" alt="kid image" width="400" height="350"/>
					 <div class="arrival-info">
					 	<center>
						 <h4>Kid Dress</h4>
						 <p>Kid long Dress</p>
					 ...
					 <div class="viw">
						<a href="kd-product.php"><span class="glyphicon glyphicon-eye-open" aria-hidden="true"></span>View</a>
					 </div>
				  </a>
			 </div>
			<div class="col-md-3 feature-grid">
				 <a href="kd-product.php"><img src="images/img6.jpg" alt="kid image" width="400" height="350"/>
					 <div class="arrival-info">
					 	<center>
		...
		<div class="col-md-3 feature-grid">
				 <a href="kd-product.php"><img src="images/img7.jpg" alt="kid image" width="400" height="350"/>
					 <div class="arrival-info">
					 	<center>
						 <h4>Short Dress</h4>
						 <p>Kid Short Dress</p>
			...
			<div class="col-md-3 feature-grid">
				 <a href="kd-product.php"><img src="images/img8.jpg" alt="kid image" width="400" height="350"/>
					 <div class="arrival-info">
					 	<center>
						 <h4>Dress</h4>
						 <p>Kid Long Dress</p>
